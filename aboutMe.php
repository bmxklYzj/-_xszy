...
//        while($row=mysql_fetch_array($query)){
        for ($i = 0; $i<$cnt; $i++) {
            ...
            <div class="row">
                <div class="img">
                    <a href="../show.php?id=<?php echo "$video_id" ?>">
                        <div class="link">
                    ...
                    <div class="shuzi">
                        <h3>已经播放过：<span class="shuzi-yanse"><?php echo "$video_click"; ?></span>次</h3>

                        <h3>已播放时间：<span class="shuzi-yanse"><?php echo "$hh"; ?></span>小时<span
                                class="shuzi-yanse"><?php echo "$mm"; ?></span>分钟<span
                                class="shuzi-yanse"><?php echo "$ss"; ?></span>秒</h3>

                        <h3>播放进度是：<span class="shuzi-yanse"><?php echo "$video_progress"; ?></span>%</h3>
                    </div>
                    <div class="jindu">
                        <div class="progress">
